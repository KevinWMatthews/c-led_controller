...
{
    LONGS_EQUAL( ATTINY861_SUCCESS, ATtiny861_GpioSetAsOutput2(ATTN861_PA0, GPIO_LOW) );
...
IGNORE_TEST(ATtiny861, set_PA1_as_output_low)
{
...
IGNORE_TEST(ATtiny861, set_PA2_as_output_low)
{
...
IGNORE_TEST(ATtiny861, set_PA3_as_output_low)
{
...
IGNORE_TEST(ATtiny861, set_PA4_as_output_low)
{
...
IGNORE_TEST(ATtiny861, set_PA5_as_output_low)
{
...
IGNORE_TEST(ATtiny861, set_PA6_as_output_low)
{
...
IGNORE_TEST(ATtiny861, set_PA7_as_output_low)
{
...
IGNORE_TEST(ATtiny861, set_PB1_as_output_low)
{
...
IGNORE_TEST(ATtiny861, set_PB2_as_output_low)
{
...
IGNORE_TEST(ATtiny861, set_PB3_as_output_low)
{
...
IGNORE_TEST(ATtiny861, set_PB4_as_output_low)
{
...
IGNORE_TEST(ATtiny861, set_PB5_as_output_low)
{
...
IGNORE_TEST(ATtiny861, set_PB6_as_output_low)
{
...
IGNORE_TEST(ATtiny861, set_PB7_as_output_low)
{
...
IGNORE_TEST(ATtiny861, set_PA0_state_low)
{
    LONGS_EQUAL( ATTINY861_SUCCESS, ATtiny861_GpioSetAsOutput(ATTN861_PA0, GPIO_HIGH) );
...
IGNORE_TEST(ATtiny861, will_not_set_state_of_invalid_gpio)
{
    LONGS_EQUAL( ATTINY861_SUCCESS, ATtiny861_GpioSetAsOutput(ATTN861_PA0, GPIO_HIGH) );
